...
namespace NOAM_ASISTENCIA.Server.Models.Utils
{
    // <summary>
    ...
    /// </summary>
    /// <typeparam name="TUser"></typeparam>
    public class CustomApiAuthorizationDbContext<TUser> : KeyApiAuthorizationDbContext<TUser, IdentityRole<Guid>, Guid>
