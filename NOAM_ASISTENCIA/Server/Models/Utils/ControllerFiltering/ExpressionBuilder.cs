...
using static NOAM_ASISTENCIA.Server.Models.Utils.ControllerFiltering.DynamicLinqExpression;
...
namespace NOAM_ASISTENCIA.Server.Models.Utils.ControllerFiltering
{
    public static class ExpressionBuilder
    {
        ...
        private static Expression<Func<T, bool>> GetExpressionFilter<T>(IList<Filter> filters)
        {
            if (filters.Count == 0)
                return null;
